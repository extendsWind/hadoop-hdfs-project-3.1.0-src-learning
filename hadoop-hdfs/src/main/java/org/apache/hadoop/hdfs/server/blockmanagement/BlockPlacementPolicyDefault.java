...
public class BlockPlacementPolicyDefault extends BlockPlacementPolicy {
  ...
  private DatanodeStorageInfo[] chooseTarget(int numOfReplicas,
    ...
    if (avoidLocalNode) {
      ...
      // # ------------ the key function --------
      // the result returned by the parameter ??
    ...
    // consider the local node by change excludedNode
    if (results == null) {
      results = new ArrayList<>(chosenStorage);
   ...
   * @param maxNodesPerRack max nodes allowed per rack  ??? **unknown meaning**
   * @param results the target nodes already chosen  ------This is a result value
  ...
  private Node chooseTarget(int numOfReplicas,
                            ...
                            final List<DatanodeStorageInfo> results,// chosenStorage node
    ...
    final int totalReplicasExpected = numOfReplicas + numOfResults; // why add ???
